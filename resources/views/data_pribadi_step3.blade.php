        ...
        <div class="w-full max-w-3xl mx-auto">
            ...
            <form action="{{ route('data_pribadi.store_step3') }}" method="POST" class="bg-white shadow-xl rounded-xl p-8 space-y-8">
                ...
                <div class="space-y-3 border-b border-gray-100 pb-6">
                    ...
                    <input type="text" name="nama_wali" class="w-full border-b border-gray-300 focus:border-[#0A2A43] outline-none py-2 px-1 transition" placeholder="Nama Lengkap Wali">
                </div>

                {{-- 36. ALAMAT WALI --}}
                <div class="space-y-3 border-b border-gray-100 pb-6">
                    <label class="block text-lg font-bold text-gray-800">Alamat Wali</label>
                    <textarea name="alamat_wali" rows="2" class="w-full border-b border-gray-300 focus:border-[#0A2A43] outline-none py-2 px-1 transition" placeholder="Alamat Lengkap Wali"></textarea>
                </div>
                ...
                <div class="space-y-3 border-b border-gray-100 pb-6">
                    ...
                    <div class="space-y-2 custom-radio">
                        ...
                        <label class="cursor-pointer block">
                            <input type="radio" name="pendidikan_wali" value="{{ $pddk_wali }}" class="hidden">
                ...
                <div class="space-y-3 border-b border-gray-100 pb-6">
                    ...
                    <input type="text" name="pekerjaan_wali" class="w-full border-b border-gray-300 focus:border-[#0A2A43] outline-none py-2 px-1 transition" placeholder="Pekerjaan Wali">
                </div>
                ...
                <div class="space-y-3 border-b border-gray-100 pb-6">
                    ...
                    <div class="space-y-2 custom-radio">
                         {{-- Opsi disesuaikan dengan Screenshot 2025-11-22 150304.png --}}
                ...
                <div class="space-y-3 border-b border-gray-100 pb-6">
                    ...
                    <input type="tel" name="no_hp_wali" class="w-full border-b border-gray-300 focus:border-[#0A2A43] outline-none py-2 px-1 transition" placeholder="08xxx">
                </div>
