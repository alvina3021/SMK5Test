...
<head>
    ...
    <title>Sosial Emosional - SMK5TEST</title>
    @vite(['resources/css/app.css', 'resources/js/app.js'])
    {{-- Tailwind CSS utility: 'Mulai Tes Sosial Emosional' design is highly centered. --}}
</head>
    ...
    <div class="w-full max-w-4xl">
        ...
        <div class="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden">
            ...
            <div class="bg-[#0A2A43] text-white p-6 md:p-8">
                <h1 class="text-2xl font-bold">Tes Sosial Emosional</h1>
                <p class="text-sm text-white/80 mt-1">Pahami kemampuan sosial dan emosional Anda melalui tes komprehensif ini.</p>
            </div>
            ...
            <div class="p-8 bg-[#F4F1FF]">
                ...
                <div class="space-y-4">
                    ...
                    <div class="bg-[#E9ECF5] rounded-xl p-5">
                        ...
                        <p class="text-gray-700 text-sm">Cari tempat tenang dan internet stabil. Kamu punya waktu untuk mengisi semua pertanyaan.</p>
                    </div>

                    <div class="bg-[#E9ECF5] rounded-xl p-5">
                        <h3 class="font-semibold text-[#0A2A43]">Jangan Overthink</h3>
                        <p class="text-gray-700 text-sm">Jawablah berdasarkan insting dan perasaan pertama Anda, bukan pemikiran yang terlalu dalam.</p>
                    </div>
                ...
                <div class="mt-8">
                    <label class="flex items-start gap-3 cursor-pointer">
                        <input type="checkbox" class="mt-1 w-5 h-5 rounded border-gray-400">
                ...
                <div class="mt-8 flex justify-center">
                    <a href="{{ route('sosial_emosional.form') }}"
