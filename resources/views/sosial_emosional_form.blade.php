...
<head>
    ...
    <style>
        ...
        /* Styling untuk radio button type 2 (Ya/Tidak) */
    ...
    @php
        $sections = [
            'Hubungan dengan Teman Sebaya' => [
                [
                    'type' => 'radio5',
                    'question' => 'Seberapa sering Anda bergaul dengan teman-teman di luar jam sekolah?',
                    'name' => 'hubungan_teman_1',
                    'options' => ['Setiap hari', 'Beberapa kali seminggu', 'Beberapa kali sebulan', 'Jarang', 'Tidak pernah']
                ],
                [
                    'type' => 'radio5',
                    'question' => 'Bagaimana Anda menilai kualitas hubungan Anda dengan teman-teman di sekolah?',
                    'name' => 'hubungan_teman_2',
                    'options' => ['Sangat baik', 'Baik', 'Cukup', 'Kurang baik', 'Sangat buruk']
                ],
                [
                    'type' => 'radio5',
                    'question' => 'Apakah Anda pernah merasa sulit untuk menjalin pertemanan?',
                    'name' => 'hubungan_teman_3',
            ...
            'Kegiatan Ekstrakurikuler dan Sosial' => [
                [
                    'type' => 'radio2',
                    'question' => 'Apakah Anda terlibat dalam kegiatan ekstrakurikuler atau organisasi di sekolah?',
                    'name' => 'ekstrakurikuler_1',
                    'options' => ['Ya', 'Tidak']
                ],
                [
                    'type' => 'text',
                    'question' => 'Jika ya, sebutkan kegiatan atau organisasi yang Anda ikuti.',
                    'name' => 'ekstrakurikuler_2',
                    'placeholder' => 'Ketik jawaban Anda di sini...'
                ],
                [
                    'type' => 'radio5',
                    'question' => 'Bagaimana perasaan Anda tentang keterlibatan Anda dalam kegiatan tersebut?',
                    'name' => 'ekstrakurikuler_3',
                    'options' => ['Sangat puas', 'Puas', 'Netral', 'Tidak puas', 'Sangat tidak puas']
                ]
            ],
            'Pengalaman Bullying' => [
                [
                    'type' => 'radio5',
                    'question' => 'Apakah Anda pernah menjadi korban bullying di sekolah?',
                    'name' => 'bullying_korban_1',
                    'options' => ['Tidak pernah', 'Jarang', 'Kadang-kadang', 'Sering', 'Sangat sering']
                ],
                [
                    'type' => 'radio5',
                    'question' => 'Apakah Anda pernah menyaksikan orang lain menjadi korban bullying di sekolah?',
                    'name' => 'bullying_saksi_1',
                    'options' => ['Tidak pernah', 'Jarang', 'Kadang-kadang', 'Sering', 'Sangat sering']
                ],
                [
                    'type' => 'radio2',
                    'question' => 'Jika Anda pernah mengalami atau menyaksikan bullying, apakah Anda melaporkannya kepada seseorang?',
                    'name' => 'bullying_laporan_1',
                    'options' => ['Ya', 'Tidak']
                ]
            ],
            'Keterampilan Sosial dan Kepercayaan Diri' => [
                [
                    'type' => 'radio5',
                    'question' => 'Seberapa nyaman Anda berbicara di depan umum atau dalam kelompok besar?',
                    'name' => 'percaya_diri_nyaman_bicara',
                    'options' => ['Sangat nyaman', 'Nyaman', 'Cukup nyaman', 'Tidak nyaman', 'Sangat tidak nyaman']
                ],
                [
                    'type' => 'radio5',
                    'question' => 'Bagaimana Anda menilai tingkat kepercayaan diri Anda dalam situasi sosial?',
                    'name' => 'percaya_diri_1',
                    'options' => ['Sangat percaya diri', 'Percaya diri', 'Cukup percaya diri', 'Kurang percaya diri', 'Sangat kurang percaya diri']
                ]
            ],
            'Dukungan Sosial' => [
                [
                    'type' => 'radio5',
                    'question' => 'Apakah Anda merasa memiliki seseorang yang bisa diajak berbicara ketika menghadapi masalah?',
                    'name' => 'dukungan_sosial_bicara',
                    'options' => ['Ya, selalu', 'Ya, kadang-kadang', 'Jarang', 'Tidak pernah']
                ],
                [
                    'type' => 'radio5',
                    'question' => 'Seberapa sering Anda merasa didukung oleh teman-teman atau keluarga Anda?',
                    'name' => 'dukungan_sosial_1',
            ...
            'Perasaan dan Emosi' => [
                [
                    'type' => 'radio5',
                    'question' => 'Seberapa sering Anda merasa bahagia dan puas dengan kehidupan Anda sehari-hari?',
                    'name' => 'perasaan_emosi_bahagia',
                    'options' => ['Sangat sering', 'Sering', 'Kadang-kadang', 'Jarang', 'Tidak pernah']
                ],
                [
                    'type' => 'radio5',
                    'question' => 'Apakah Anda pernah merasa kesepian atau terisolasi?',
                    'name' => 'perasaan_emosi_kesepian',
                    'options' => ['Tidak pernah', 'Jarang', 'Kadang-kadang', 'Sering', 'Sangat sering']
                ],
                [
                    'type' => 'radio5',
                    'question' => 'Bagaimana perasaan Anda dalam dua minggu terakhir?',
                    'name' => 'perasaan_emosi_dua_minggu',
                    'options' => ['Selalu bahagia dan bersemangat', 'Kadang-kadang merasa bahagia dan bersemangat', 'Sering merasa sedih atau cemas', 'Selalu merasa sedih atau cemas']
                ]
            ]
        ];
    @endphp
        ...
        <div class="w-full max-w-3xl mx-auto">
            <form method="POST" class="space-y-6">
                ...
                <div class="mt-10 flex justify-between gap-4">
                    ...
                    <a href="{{ route('sosial_emosional_step2') }}" class="w-1/2 text-center bg-[#0A2A43] text-white font-bold text-lg py-3 px-6 rounded-xl shadow-lg hover:bg-[#143d5e] transition duration-200">
                        Selanjutnya
                    </a>
                </div>
            </form>
