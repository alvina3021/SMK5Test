...
<head>
    ...
    <title>Data Pribadi Siswa - SMK5TEST</title>
    @vite(['resources/css/app.css', 'resources/js/app.js'])
    {{-- Tailwind CSS utility: 'Mulai Tes Identitas Siswa' design is highly centered. --}}
</head>
    ...
    <div class="w-full max-w-4xl">
        ...
        <div class="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden">
            ...
            <div class="bg-[#0A2A43] text-white p-6 md:p-8">
                <h1 class="text-2xl font-bold">Data Pribadi Siswa</h1>
                <p class="text-sm text-white/80 mt-1">Lengkapi informasi dasar sebelum memulai tes utama.</p>
            </div>
            ...
            <div class="p-8 bg-[#F4F1FF]">
                ...
                <div class="space-y-4">
                    ...
                    <div class="bg-[#E9ECF5] rounded-xl p-5">
                        ...
                        <p class="text-gray-700 text-sm">Cari tempat tenang dan internet stabil. Kamu punya 30 menit untuk 20 soal.</p>
                    </div>
                ...
                <div class="mt-8 flex justify-center">
                    <a href="{{ route('data_pribadi.form') }}"
